...
from prediction_market_agent_tooling.tools.contract import ContractOnGnosisChain, abi_field_validator
from prediction_market_agent_tooling.tools.gnosis_rpc import GNOSIS_RPC_URL
from pydantic import BaseModel
from web3 import Web3

SERVICE_REGISTRY_ADDRESS = Web3.to_checksum_address("0x9338b5153AE39BB89f50468E608eD9d764B755fD")
...
def fetch_service_by_service_id(abi:ABI, service_id: int) -> MechIPFSDescription:
    ...
    result = services.call("getService",[service_id], web3=Web3(Web3.HTTPProvider(GNOSIS_RPC_URL)))
...
def main():
    ...
    for service_id in tqdm.trange(1,10):
        try:
            mech_ipfs_description = fetch_service_by_service_id(abi=abi, service_id=service_id)
