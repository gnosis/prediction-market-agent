...
from dotenv import load_dotenv   #use environemnt



from prediction_market_agent.agents.advanced_agent.deploy_crypto import AdvancedAgent
...
def main(
    ...
    load_dotenv()   #added to load environment
