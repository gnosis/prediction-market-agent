...
class CorrelatedQuestionsAgent:
    ...
    def answer_binary_market(self, question: str) -> bool:
        """
        ...
        # ToDo - fetch markets by title
        sh = OmenSubgraphHandler()
        markets = sh.get_omen_market_by_market_id()
        # markets.current_p_yes, markets.current_p_no
        return False
